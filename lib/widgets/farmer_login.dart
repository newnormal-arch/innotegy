...
class FarmerLogin
  ...
  State<
    FarmerLogin
  >
  createState() => _FarmerLoginState();
}

class _FarmerLoginState
    extends
        State<
          FarmerLogin
        > {
      ...
      body: Center(
        child: Column(
          ...
          children: [
            ...
            //               ) {
            //                 print(
            //                   'User signed in successfully as Farmer: ${value.user?.uid}',
            //                 );
            //                 Navigator.of(
            //                   context,
            //                 ).pushReplacement(
                ...
                onPressed: () async {
                  ...
                  try {
                    ...
                    UserCredential userCredential = await authService.value.signIn(
                      email: farmerEmailController.text.trim(),
                      password: farmerPasswordController.text.trim(),
                      requiredCollection: 'farmer',
                    );

                    print(
                      'User signed in successfully as Farmer: ${userCredential.user?.uid}',
                    );
                    EasyLoading.dismiss();
